...
public class FlightController {
    	...
    	addMavlinkListener(
                ...
                new MavLinkListener() {
                    ...
                    public void receive(MAVLinkMessage mavLinkMessage)  {
                    	...
                    	//�떎�쓬 �닚�꽌: receiveMavlinkMissionAck() 紐⑤뱺 誘몄뀡 �븘�씠�뀥�씠 FC濡� �쟾�떖�맂 寃쎌슦
                    }
                }
        );
    }
    	...
    	addMavlinkListener(
                ...
                new MavLinkListener() {
                    ...
                    public void receive(MAVLinkMessage mavLinkMessage)  {
                    	...
                    	//MAV_CMD_DO_GRIPPER�뒗 MAVLINK_MSG_ID_MISSION_CURRENT媛� �삤吏� �븡�뒗�떎.(ArduCopter V3.6-dev, mavlink 1.0)
    ...
    private void sendMavlinkMissionRequestList() {
        ...
        msg.target_component = MAV_COMPONENT.MAV_COMP_ID_AUTOPILOT1;
        mavlinkSendToFc(msg);
        //�떎�쓬 �닚�꽌: mavlinkListenerMissionCount() �뿉�꽌 �떎�슫濡쒕뱶 諛쏆쓣 誘몄뀡 �븘�씠�뀥 珥� �닔瑜� �뼸�쓬
    }
    //----------------------------------------------------------------------------
    private void sendMavlinkMissionRequestInt(int seq) {
        ...
        msg.seq = seq;
        mavlinkSendToFc(msg);
        //�떎�쓬 �닚�꽌: mavlinkListenerMissionItemInt() �뿉�꽌 �떎�슫濡쒕뱶 諛쏆쓣 誘몄뀡 �븘�씠�뀥 珥� �닔瑜� �뼸�쓬
    }
    //----------------------------------------------------------------------------
    ...
    private void sendMavlinkFenceFetchPoint() {
    	...
    	//�떎�쓬 �닚�꽌: mavlinkListenerFencePoint()
    }
    //----------------------------------------------------------------------------
        ...
        addMavJsonListener(
                ...
                new MavJsonListener() {
                    ...
                    public void receive(JSONObject jsonMessage) {
                        ...
                        //�떎�쓬 �닚�꽌: receiveMavlinkMissionRequest()�뿉�꽌 �븯�굹�뵫 FC濡� 誘몄뀡 �븘�씠�뀥 �쟾�넚
                    }
                });
    }
    //----------------------------------------------------------------------------
